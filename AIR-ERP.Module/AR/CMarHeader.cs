...
namespace AIR_ERP.Module
{
    ...
    [NavigationItem("Accounts Receivable"), System.ComponentModel.DisplayName("Credit Memo")]
    [RuleCriteria("RuleCMarHeaderDocNum", DefaultContexts.Save, "DocNum != 0", "Document Number shouldn't be 0", SkipNullOrEmptyValues = false)]
    public class CMarHeader : BaseObject
    {
        public CMarHeader(Session session) : base(session) { }
        public CMarHeader()
        {
        ...
        [RuleRequiredField("RuleRequiredField for CMarHeader.Currency", DefaultContexts.Save)]
        ...
        [RuleRequiredField("RuleRequiredField for CMarHeader.VatCategory", DefaultContexts.Save)]
        ...
        private Term term;
        [RuleRequiredField("RuleRequiredField for CMarHeader.Term", DefaultContexts.Save)]
        ...
        [RuleRequiredField("RuleRequiredField for CMarHeader.BusinessPartner", DefaultContexts.Save)]
        ...
        [PersistentAlias("CMarOther[].Sum(Price * Quantity)")]
        ...
        {
            _TotalAmount = 0m;
            foreach (CMarOther CMarOther in CMarOthers)
            {
                _TotalAmount += CMarOther.Price * CMarOther.Quantity;
            }
        ...
        [Association("CMarHeader-CMarOthers"), Aggregated]
        public XPCollection<CMarOther> CMarOthers
        {
            get
            {
                return GetCollection<CMarOther>("CMarOthers");
            }
        }
